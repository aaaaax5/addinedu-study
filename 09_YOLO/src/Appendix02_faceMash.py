...
result1 = cv2.VideoWriter("../data/Output.mp4", cv2.VideoWriter_fourcc(*'mp4v'), 25, (1280, 720))
cap.set(3, width)
cap.set(4, height)

image = cv2.imread("../data/manFace.jpg")
...
def set_src_image(image):
    global src_image, src_image_gray, src_mask, src_landmark_points, src_convexHull, indexes_triangles
    src_image = image
...
while True:
    ...
    for triangle_index in indexes_triangles:
        points, src_cropped_triangle, cropped_triangle_mask, rect = triangulation(
