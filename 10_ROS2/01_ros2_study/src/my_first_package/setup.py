...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'publish_flag = my_first_package.publish_flag:main',
            'rotate_on_flag = my_first_package.rotate_on_flag:main',
            'change_pen_color = my_first_package.change_pen_color:main'
        ],
    },
)